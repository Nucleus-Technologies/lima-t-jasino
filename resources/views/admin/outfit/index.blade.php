            ...
            <div class="col-lg-12 mb-5 mb-xl-0 mt-5">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Children Outfits</h3>
                            </div>
                            @if (!$children_outfits->isEmpty())
                                <div class="col text-right">
                                    <div class="form-group w-75 m-0 float-right">
                                        <div class="input-group input-group-sm">
                                            <div class="input-group-prepend">
                                            ...
                                            <input class="form-control" id="children-outfit-search" placeholder="Search by type, by name, by availibility, ..." type="text">
                                        </div>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="table-responsive table-outfits">
                            <div>
                                <table class="table align-items-center">
                                    ...
                                    <tbody class="list" id="children-list">
                                        @foreach ($children_outfits as $outfit)
                                            <tr>
                                                <th scope="row" class="name">
                                                    <div class="media align-items-center">
                                                        <a href="#" class="avatar rounded-circle mr-3">
