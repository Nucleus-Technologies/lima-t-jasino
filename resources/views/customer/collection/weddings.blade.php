    ...
    @include('customer.layouts.partials._banner', [
        "banner_content" => "<h2>" .$title. "</h2>
            <div class='page_link'>
                ...
                <a href=" .route('collection.weddings'). ">Weddings</a>
            </div>
        "
    ])
    ...
    <section class="collection-group-area section_gap">
        <div class="container-fluid">
            <div class="grid row ml-0 mr-0">
                @for ($i = 1; $i <= number_files('weddings'); $i++)
                    <div class="col-12 col-md-6 col-lg-4 grid-item">
                        <div class="card">
                            <img src="{{ asset('customer/img/collection/weddings/' .$i. '.jpg') }}" class="card-img-top" alt="collection-image">
                        </div>
                    </div>
                @endfor
            </div>
